...
export function DashboardSidebar({ isCollapsed, toggleCollapse, onSignOut }: SidebarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between p-4 border-b border-[var(--color-border)]">
        {!isCollapsed && <span className="text-xl font-bold text-[var(--color-primary)]">ClaimGuard</span>}
        <button
